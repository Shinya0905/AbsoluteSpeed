...
{
    //値切り出す
    /// <summary>壁用ペナルティ。1のときペナルティ無し</summary>
    private float mWallPenalty = 1.0f;
    /// <summary>ドリフトペナルティ。1のときペナルティ無し</summary>
    private float mDriftPenalty = 1.0f;
    /// <summary>AIと衝突したときのペナルティ。1のときペナルティ無し</summary>
    private float mAiPenalty = 1.0f;
    /// <summary>エンジンの値管理クラス</summary>
    private readonly VehicleSettings.EngineSettings mEngineSettings;
    /// <summary>ペナルティの値管理クラス</summary>
