...
{
    //Gizmos
    [SerializeField, Tooltip("デバッグ用ギズモを表示する")]
    private bool mGizmoSwitch = true;
    [SerializeField, Tooltip("デバッグ用GUIの表示スイッチ")]
    private bool mGUISwitch = true;

    /// <summary>車の設定情報管理クラス</summary>
